<?php
	try
	{
		...
		if(!empty($search_phrase))
		{
			...
			$where  = "WHERE nombre_usuario LIKE '".$search."%' OR email LIKE '".$search."%' OR cuil_usuario LIKE '".$search."%' ";
			
		}
		

		//Consulta para obtener los resultados		
		$sql = "SELECT us.id_usuario, us.nombre_usuario, us.rol, us.activo, us.fecha_alta, us.email, us.contrasenia, us.telefono_usuario, us.cuil_usuario, us.domicilio_usuario, us.celular_usuario FROM usuarios us {$where} ORDER BY {$order_by} {$limit}";
