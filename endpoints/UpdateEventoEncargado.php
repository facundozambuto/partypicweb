<?php
    ...
    function post_data($args)
    {
          ...
          if($nombre_evento == null || $descripcion == null)
          {
            $res['success'] = false;
          ...
          { 
            ...
            $query = "UPDATE eventos SET nombre_evento = '{$nombre_evento}', descripcion = '{$descripcion}', id_salon = '{$id_salon}' WHERE id_evento = '{$id_evento}'";
