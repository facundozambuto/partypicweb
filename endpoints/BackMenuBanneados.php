<?php
	try
	{
		...
		$sql = "SELECT * FROM usuarios_banneados ub INNER JOIN usuarios us ON us.id_usuario = ub.id_usuario LEFT JOIN salones sal ON sal.id_usuario = us.id_usuario LEFT JOIN eventos ev ON ev.id_salon = sal.id_salon WHERE sal.id_salon IS NULL UNION SELECT * FROM usuarios_banneados ub INNER JOIN usuarios us ON us.id_usuario = ub.id_usuario LEFT JOIN salones sal ON sal.id_usuario = us.id_usuario LEFT JOIN eventos ev ON ev.id_salon = sal.id_salon WHERE ub.id_evento = ev.id_evento {$where} ORDER BY {$order_by} {$limit}";
		...
		$query_count = "SELECT count(*) FROM usuarios_banneados";
