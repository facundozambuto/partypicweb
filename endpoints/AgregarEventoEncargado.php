<?php
  ...
  function post_data($args)
  {
    ...
    if($nombre_evento == null || $descripcion == null || $fecha == null || $id_salon == null)
    {
      $res['success'] = false;
    ...
    else
    {
      ...
      else
      {
          ...
          $query = "INSERT INTO eventos SET nombre_evento = '{$nombre_evento}', descripcion = '{$descripcion}', fecha = '{$fecha}', id_salon = '{$id_salon}', habilitado = 0, codigo = '{$codigo}', codigo_qr = '{$codigo_qr}'";
