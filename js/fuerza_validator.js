...
(function ($) {
    ...
    var options = {
            ...
            minChar: 8,
            errorMessages: {
                password_to_short: "La contraseña es demasiado corta.",
                same_as_username: "La contraseña no puede ser igual al e-mail"
            },
            scores: [17, 26, 40, 50],
            verdicts: ["Débil", "Aceptable", "Normal", "Fuerte", "Muy Fuerte"],
            showVerdicts: true,
            raisePower: 1.4,
        ...
        methods = {
            ...
            outputErrorList: function () {
                this.each(function (idx, el) {
                    var output = '<ul id="errors_pass" class="error-list">',
                        $el = $(el),
