...
<html class="no-js" lang="es"><!--<![endif]-->
  ...
  <body>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-md-12 col-lg-12" style="margin-bottom:20px">    
                        ...
                        <div class="form-group mb-7px">
                          ...
                          <div class="col-md-9">
                              <input id="fecha" type="text" class="form-control some_class" name="fecha" placeholder="Fecha">
                          </div>
                        </div>
                        <div class="form-group mb-7px">
                        ...
                        <div class="form-group mb-7px">
                          ...
                          <div class="col-md-4">
                            <select id="habilitado" class="form-control" name="habilitado">
	            	...
	            	<div class="row">
	                  <div class="col-xs-12 col-md-12 col-lg-12"  style="margin-bottom:20px"> 
	                    <div class="col-md-offset-1 col-lg-offset-1 col-md-10 col-lg-10"> 
		                  ...
		                  <a href="../admin/menusalones.php" class="btn btn-primary">Editar / Ver Salones</a>
                		</div>         
	                  </div>                  
	          	    </div>
	              </div>
    ...
    <!-- /#wrapper -->
    <script type="text/javascript" src="../admin/js/menueventos.js"></script>
  </body>
</html>