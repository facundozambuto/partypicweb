...
<html class="no-js" lang="es"><!--<![endif]-->
  <head>
    ...
    <script type="text/javascript" src="../admin/js/initDashboard.js"></script>
        ...
        <div class="container" style="padding-left: 0; padding-right: 0">
          ...
          <div class="col-md-3">
            <div class="panel panel-info">
              <div class="panel-heading dashboard-salones">
                <div class="row">
                  <div class="col-xs-6">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading"><?php
					    $res = array();
					    $sql = "SELECT * FROM salones WHERE salones.create_date >= ( NOW( ) - INTERVAL 1 MONTH )";
                    ...
                    <p class="announcement-text">Nuevos Salones</p>
                  </div>
                </div>
              </div>
              <a href="../admin/menusalones.php">
              ...
              <div class="panel-heading dashboard-eventos">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading"><?php
				    $res = array();
				    $sql = "SELECT * FROM eventos WHERE eventos.fecha >= ( NOW( ) - INTERVAL 1 MONTH )";
              ...
              <div class="panel-heading  dashboard-imagenes">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading"><?php
				    $res = array();
				    $sql = "SELECT * FROM eventos ev INNER JOIN imagenes im ON ev.id_evento = im.id_evento WHERE ev.fecha >= ( NOW( ) - INTERVAL 1 MONTH )";
          ...
          <div class="col-md-3">
            <div class="panel panel-success">
              <div class="panel-heading dashboard-ingresos">
                <div class="row">
                  <div class="col-xs-6">
                    <i class="fa fa-money fa-5x"></i>
                  </div>
                  <div class="col-xs-6 text-right">
                    <p class="announcement-heading">$75.846</p>
                    <p class="announcement-text">Ingresos mensuales <i class=""></i>  </p>
                  </div>
                </div>
              </div>
              <a href="../admin/menuingresos.php">
                <div class="panel-footer announcement-bottom">
                  <div class="row">
                    <div class="col-xs-6">
                      Ver detalles
