...
<html class="no-js" lang="es"><!--<![endif]-->
  <head>
    ...
    <title>Party Pic App - Menú de Usuarios Banneados</title>
  ...
  <body>
      ...
      <div class="container container-ppal" style="margin-top:40px; margin-bottom:40px">
        <div class="row">
          <div class="btn-group btn-breadcrumb pull-left">
            ...
            <a href="../admin/menubanneados.php" class="btn btn-primary">Menú Usuarios Banneados</a>
          </div>
        </div>
      </div>
    ...
    <!-- /#wrapper -->
    <script type="text/javascript" src="../admin/js/menubanneados.js"></script>
  </body>
</html>